        ...
        <>
            ...
            <div className='right-section' >
                ...
                <div className='right-chats-section'>
                    ...
                    {
                        rightSectionData.length !== 0 ? rightSectionData.msg.map((ele,idx)=><div key ={idx} className="left"><p>{ele}</p></div>) :  <Default/>
                    }
                    {
                ...
                {
                    rightSectionData.length !== 0 ? <div className='input'>
